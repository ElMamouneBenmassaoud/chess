...
public class RookTest {
   Board board;
     ...
     */
    @Test
    public void rookRightCornerPos() {
     ...
     */
    @Test
    public void rookMiddlePosWithPieces() {
        Position position = new Position(3, 3);
        Piece piece = new Rook(Color.WHITE);
        board.setPiece(piece, position);
    ...
    /**
     * Test of getCapturePositions method, of class Rook.
     */
    @Test
